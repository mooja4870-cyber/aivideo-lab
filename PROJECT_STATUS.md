...
최종 업데이트: 2026-03-30 23:55:41 (KST)
담당: Codex + mooja
...
### 2026-03-30 23:55:41 (KST)
- 변경: 스케일 요금 179,000원 -> 199,000원 조정
- 이유: 요청 가격 정책 반영
- 검증: `constants.ts`와 `cost-pricing.md`의 스케일 가격/단가 값 동기화 확인
- 배포 영향: 프론트 가격 표기/결제 요청 금액 기준에 반영
- 남은 TODO: 배포 후 운영 URL에서 `₩199,000` 노출 및 결제 금액 반영 확인
